...
cdeBrowserApp.controller('cdeBrowserController', function ($scope, $http) {
    ...
    $scope.displaySelected2 = function (data) {
        console.log(data);
    ...
    $scope.dataLoad0 = function () {
        ...
        //FIXME - The start message does not show, but the done message does.
        //$scope.waitMessage = "Wait.....";
    ...
    $scope.dataLoad2b = function () {
        $http.get("data3.json").success(function (response) {
            $scope.contextList = response;
        });
    };
...
(function ( angular ) {
    ...
    angular.module( 'cdebrowserTreeview', [] )
        ...
        .directive('resizeTree', function ($window) {
