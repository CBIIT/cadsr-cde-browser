...
public class LookupDataControllerTest
{
	...
	private static final String[] EXPECTED_REG_STATUS = { "ALL Registration Statuses", "Standard", "Candidate", "Proposed", "Qualified",
			"Superceded", "Standardized Elsewhere", "Retired", "Application", "Suspended", "" };

	private static final String[] EXPECTED_WRK_FLW_STATUS = {"ALL Workflow Statuses", "RELEASED", "APPRVD FOR TRIAL USE", "DRAFT NEW",
