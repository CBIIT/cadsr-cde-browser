...
public class BasicSearchControllerTest extends TestCase
{
    ...
    public void testProgramAreaPalNameLookUp10()
    {
        int i = 0;
        for( ProgramAreaModel model: programAreaModelList)
        {
            System.out.println("Prog: " + model);
            System.out.println("Prog: " +  basicSearchController.getProgramAreaPalNameByIndex( i ));
            i++;
        }
    }
    ...
    {
        // Zero is "All" which should return an empty (not null) String
