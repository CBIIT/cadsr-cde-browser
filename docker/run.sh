...
mvn -f v5/cdebrowser/pom.xml -DCADSR_DS_USER=${CADSR_DS_USER} -DCADSR_DS_PSWD=${CADSR_DS_PSWD} -Dtag=${tag} -Dtier=${tier} -P 12c -s v5/cdebrowser/settings.xml clean package
